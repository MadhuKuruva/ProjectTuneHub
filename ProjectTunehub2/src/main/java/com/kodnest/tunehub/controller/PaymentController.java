...
public class PaymentController {
	...
	public String createOrder(HttpSession session) {
		...
		Order order=null;
		try {
			RazorpayClient razorpay=new RazorpayClient("rzp_test_zVM0BJ5eV4mPGe", "CXKYIRqUPtjWdPm5mIVGuFXB");
...
//			Users user = userService.getUser(mail);
...
//			userService.updateUser(user);
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
	    ...
	    try {
	        ...
	        RazorpayClient razorpayClient = new RazorpayClient("rzp_test_zVM0BJ5eV4mPGe", 
	        								"CXKYIRqUPtjWdPm5mIVGuFXB");
